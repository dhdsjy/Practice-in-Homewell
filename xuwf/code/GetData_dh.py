...
#        return data,t,ts
    ...
    #创建与hbase的链接
            ...
            #    timestamp=sensorno+1
                ...
                connection.close()
                return df.to_csv('/home/xuwf/xuwf/data/data_for_fsc/ready_for_experiment/Residual_current_3month_for_entity95401.csv')
                
                #return df
                
                
if __name__=='__main__':    
    dd = GetData('historydata')   
    aa=dd.gethistorydata(95401,"2017-09-07 00:00:00","2017-11-28 23:59:59",sensorno=6)# end to 2017.7.28
